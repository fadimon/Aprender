...
return [
    ...
    |
     */
    //con esta matriz de atributos, puedo personalizar el mensaje que aparece al validar campo, en vez del nombre del campo de la tabla a modificar aparecera lo que quiero que aparezca.
    /*ej:
    'attributes'           => [
    'nombre del campo en la tabla' => 'lo que deseo que aparezca en el mensaje',
    ],*/
    'attributes'           => [
